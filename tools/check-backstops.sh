...
""",
    ...
    },
    {
        ...
        "also": ["tools/check.sh",
                 ...
                 "if ! ${MAKE:-make} debug embed embed-debug engine engine-debug least tools/inward \\"],
        "make": [],
        "tool": "tools/check-tables.sh",
    ...
    },
    {
        ...
        "file": "src/check.c",
        "from": r"""    "add", "array", "bits", "clear", "find",  "float", "get",   "hash",""",
        "to": r"""    "add", "array", "bits", "clear", "find",  "float", "get",""",
        "make": [],
        "tool": "tools/check-tables.sh",
    ...
    },
    {
        ...
        "file": "src/check.c",
        "from": r"""    "len", "matches", "fit", "pop",   "push",   "remove", "rest", "room",
    "set", "slice", "store",""",
        "to": r"""    "len", "matches", "fit", "pop",   "push",   "remove", "rest", "room",
    "set", "slice", "store", "take",""",
        "make": [],
        "tool": "tools/check-tables.sh",
...
""",
    ...
    },
    {
        ...
        "file": "src/build.c",
        "from": r"""    return build == NULL ? 0 : kest_arena_widest(build->arena);""",
...
""",
    ...
    },
    {
        ...
        "tool": "tools/check-costs.sh",
        "arguments": [],
        "caught": "a frame step an entity is 40 instruction(s)",
    },
    {
...
anywhere, and it is why the gate holds""",
    ...
    },
    {
        ...
        "file": "src/vm.c",
        "from": """        fprintf(stderr, "guards %llu reentered %llu\\n",
                (unsigned long long)runtime->guarded,
                (unsigned long long)runtime->reentered);""",
        "to": """        fprintf(stderr, "guards %llu reentered %llu\\n", 0ULL,
                (unsigned long long)runtime->reentered);""",
        "make": ["kest", "debug"],
        "tool": "tools/check-costs.sh",
        "arguments": [],
...
""",
    ...
    },
    {
        ...
        "from": r"""static const uint8_t one_piece_of_text[] = {KEST_L_TEXT};""",
...
// The next line of what was read""",
    ...
    },
    {
        ...
        "what": "a build that says it cost nothing",
        "file": "src/build.c",
        "from": """    return build == NULL ? 0 : kest_arena_widest(build->arena);""",
...
fn main() -> i32 {
    ...
    },
    {
        ...
        "file": "docs/language.md",
        "from": """kest 0.0.2, abi 4, json 4, profile kest-det 3, edition 2026""",
        "to": """kest 0.0.2, abi 1, json 1, profile kest-det 1, edition 2026""",
        "make": ["kest"],
        "tool": "tools/check-docs.sh",
        "arguments": ["docs/language.md", "docs/decisions.md"],
