...
reasoning; this holds the position.
    ...
    CURRENT SHA:       (this commit) D1093-D1248
    ...
    LAST CI:           green on 9567a115, all ten jobs -- linux,
    ...
    LAST FULL GATE:    CI's `linux-full` on 9567a115, every hole caught; the
                       sweep here on D1248, 917 holes, every one caught
