...
K0310|fn main() -> i32 {\n    let n = 1\n    return i32(bits(n))\n}|`bits` is what an `f32` or an `f64` is made of, found `i32`
K0310|fn main() -> i32 {\n    let n = 1\n    return i32(float(n))\n}|`float` is the float a `u32` or a `u64` holds the bits of, found `i32`
...
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.at {\n    let x = 1\n    wait Walking\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`x` is in reach of this `wait`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.at {\n    wait Walking\n    wait Walking\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`Walking` is waited at twice
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.at {\n    wait Carrying\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`Carrying` carries something
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.at {\n    wait Flying\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`Flying` is not a case of `At`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C {\n    wait Walking\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`wait` is written in a body that resumes
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> i32 resumes c.at {\n    return 1\n}\n\nfn main() -> i32 {\n    return 0\n}|`f` resumes from `c`, so it gives back a `C`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.n {\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|a body resumes from a field that is an enum, and `n` is `i32`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes d.at {\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`d` is not something `f` takes
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.nope {\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`C` has no field `nope`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(n: i32) -> i32 resumes n.at {\n    return n\n}\n\nfn main() -> i32 {\n    return 0\n}|a body resumes from a struct it is handed
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn done(x: i32) {\n}\n\nfn f(c: C) -> C resumes c.at {\n    defer done(1)\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|a body that resumes runs no `defer`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.at {\n    scratch {\n        wait Walking\n    }\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|a `scratch` block is open at this `wait`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f(c: C) -> C resumes c.at {\n    for i in 0..3 {\n        wait Walking\n    }\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|`i` is in reach of this `wait`
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn each(xs: [i32], body: block(i32)) {\n    for x in xs {\n        body(x)\n    }\n}\n\nfn f(c: C) -> C resumes c.at {\n    each([1], \0174x\0174 {\n        wait Walking\n    })\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|a block cannot wait
K0368|enum At {\n    Start\n    Walking\n    Carrying(i32)\n    Done\n}\n\nstruct C {\n    n: i32\n    at: At\n}\n\nfn f<T>(c: C, t: T) -> C resumes c.at {\n    return c\n}\n\nfn main() -> i32 {\n    return 0\n}|a body that resumes takes no types
K0369|fn main() -> i32 {\n    for v in fields(3) {\n    }\n    return 0\n}|`fields` walks a struct, and this is `i32`
K0369|struct P {\n    x: i32\n}\n\nfn make() -> P {\n    return P(1)\n}\n\nfn main() -> i32 {\n    for v in fields(make()) {\n    }\n    return 0\n}|`fields` walks a struct a name holds
